...
\subsection{Stage 1 --- Decode \& Compute (1 cycle, registered output)}
...
\subsection{Backpressure \& Control Signals}
...
\subsection{Three Paths Through the Splitter}
